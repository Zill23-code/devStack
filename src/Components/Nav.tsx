...
const Nav = () => {
    return <nav className='flex justify-between container mx-auto py-4 border-b border-b-blue-100 sticky top-0 z-50'>
       ...
       <button className='h-15 w-25 bg-fuchsia-600 text-white p-4 rounded-[9999px] border-2'>Sign Up</button>
       </div>
    </nav>
